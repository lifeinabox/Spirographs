...
def saveDrawing():
    ...
    # save the drawing as postcript image
    canvas.postscript(file=fileName + '.eps')
    # use the Pillow module to convert to postscritpt image file to PNG
